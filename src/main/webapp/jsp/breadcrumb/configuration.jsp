...
<aui:form action="<%= configurationURL %>" method="post">
	...
	<aui:select label="View Selection" name="preferences--view--">
		<aui:option selected="<%= view.equals(\"standard.jsp\") %>" value="standard.jsp">Standard</aui:option>
		<aui:option selected="<%= view.equals(\"reserve.jsp\") %>" value="reserve.jsp">Digital Reserve</aui:option>
	</aui:select>
