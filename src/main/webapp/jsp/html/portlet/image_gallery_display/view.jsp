...
<c:choose>
	<c:when test="<%= portletDisplayDDMTemplateId > 0 %>">
		...
		final ThemeDisplay themeDisplay_ = themeDisplay;
		List fileEntries = new java.util.ArrayList();
		List files = DLAppServiceUtil.getGroupFileEntries(scopeGroupId, 0, folderId, mediaGalleryMimeTypes, status, 0, SearchContainer.MAX_DELTA, null);
		fileEntries.addAll(files);
		
		//sort by ratings high to low
		java.util.Collections.sort(fileEntries, new java.util.Comparator() {
			public int compare(Object o1, Object o2) {
				try {
					com.liferay.portal.kernel.repository.model.FileEntry e1 = (com.liferay.portal.kernel.repository.model.FileEntry)o1;
					com.liferay.portal.kernel.repository.model.FileEntry e2 = (com.liferay.portal.kernel.repository.model.FileEntry)o2;
					com.liferay.portlet.ratings.model.RatingsEntry entry1 = com.liferay.portlet.ratings.service.RatingsEntryLocalServiceUtil.getEntry(themeDisplay_.getUserId(), "com.liferay.portlet.documentlibrary.model.DLFileEntry", e1.getPrimaryKey());
					com.liferay.portlet.ratings.model.RatingsEntry entry2 = com.liferay.portlet.ratings.service.RatingsEntryLocalServiceUtil.getEntry(themeDisplay_.getUserId(), "com.liferay.portlet.documentlibrary.model.DLFileEntry", e2.getPrimaryKey());
					
					return Double.valueOf(entry2.getScore()).compareTo(Double.valueOf(entry1.getScore()));
				} catch(Exception e) {
					//e.printStackTrace();
				}
				return 0;
