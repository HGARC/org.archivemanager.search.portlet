...
<div>
	<div style="background-color:#CD2626;margin:20px;">
		<div style="padding:10px;">
			<div style="background-color:#FFFFFF;color:#333333;font-weight:bold;text-align:center;">
				<div style="padding:10px;">CLICK HERE TO VIEW THE INVENTORY OF THE COLLECTION</div>
			</div>
		</div>
		<div style="padding:10px;text-align:center;">
			<a href="<c:out value="${findingAid}" />">
				<img style="width:50px;" src="/theme/images/pdf.png" />
			</a>
		</div>	
	</div>
</div>
